    ...
    public partial class InitialAuthCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", new DateTime(2026, 1, 24, 3, 29, 56, 216, DateTimeKind.Utc).AddTicks(2898), "Administrateur avec tous les droits", "Admin" },
                    { "2", new DateTime(2026, 1, 24, 3, 29, 56, 216, DateTimeKind.Utc).AddTicks(2904), "Utilisateur standard", "User" },
                    { "3", new DateTime(2026, 1, 24, 3, 29, 56, 216, DateTimeKind.Utc).AddTicks(2907), "Modérateur du contenu", "Moderator" }
                });
